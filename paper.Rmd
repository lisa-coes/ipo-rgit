...
geometry: "left=3cm,right=3cm,top=2cm,bottom=2cm" # márgenes de página
header-includes:
...
# Custom names para coeficientes: 
custom.coef.names = c(                                                    
  "Intercept",
...
knitreg(list(m,m2),                            # Modelos 1 y 2
       ...
       float.pos = "H",                        # Fijar posición de tabla  
...
`r if (knitr::is_latex_output()){ '\\appendix'}` # Si documento es latex, se genera seccion de Anexos
